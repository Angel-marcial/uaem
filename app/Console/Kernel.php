...
Descripción: Este archivo PHP es una parte esencial del framework Laravel y se encuentra en el contexto del proyecto de control de accesos a la UAPT. Su función principal es manejar la programación de comandos y tareas en la aplicación mediante el uso del componente de programación de tareas de Laravel.
