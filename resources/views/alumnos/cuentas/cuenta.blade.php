<!--
    ...
    Descripción: Este archivo PHP contiene lainformacion del alumno
-->
            ...
            <form action="{{ url('editar-alumno/'.$alumno->id) }}" method="POST" onsubmit="return alumno(this)">
                ...
                <div class="margenes-contenedor">
                    ...
                    <div>
                        ...
                        <input type="text" class="form-control text-contenedor" id="nombres" name="nombres" value="{{ old('nombres', $alumno->nombre ?? '') }}" required disabled oninput="textos(this)">
                    </div>

                    <div>
                        <label for="apellidoPaterno" class="form-label titulos margenes-contenedor">Apellido Paterno</label>
                        <input type="text" class="form-control text-contenedor" id="apellidoPaterno" name="apellidoPaterno" value="{{ old('apellidoPaterno', $alumno->apellido_paterno ?? '') }}" required disabled oninput="textos(this)">
                    </div>

                    <div>
                        <label for="apellidoMaterno" class="form-label titulos margenes-contenedor">Apellido Materno</label>
                        <input type="text" class="form-control text-contenedor" id="apellidoMaterno" name="apellidoMaterno" value="{{ old('apellidoMaterno', $alumno->apellido_materno ?? '') }}" required disabled oninput="textos(this)">
                    </div>

                    <div>
                        <label for="telefono" class="form-label titulos margenes-contenedor">Teléfono</label>
                        <input type="number" class="form-control text-contenedor" id="telefono" name="telefono" value="{{ old('telefono', $alumno->telefono ?? '') }}" required disabled oninput="validarTelefono(this)">
                    </div>

                    <div>
                        <label for="correo" class="form-label titulos margenes-contenedor">Correo</label>
                        <input type="email" class="form-control text-contenedor" id="correo" name="correo" value="{{ old('correo', $alumno->correo ?? '') }}" required disabled>
                    </div>

                    <div>
                        <label for="password" class="form-label titulos margenes-contenedor">Contraseña</label>
                        <div class="input-group">
                            <input type="password" class="form-control text-contenedor" id="password" name="password" value="{{ old('password', $alumno->password ?? '') }}" required disabled>
