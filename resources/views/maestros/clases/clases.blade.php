...
@section('content')
                                ...
                                <tbody>
                                    ...
                                    @foreach($dias as $index => $dia)
                                        <tr>
                                            <td>{{ $dia }}</td>
                                            <td>
                                                <input type="time" class="form-control entrada" id="entrada_{{ strtolower($dia) }}" name="entrada_{{ strtolower($dia) }}" value="{{ old('entrada_'.strtolower($dia), $entradas[$index]) }}" disabled>
                                            </td>
                                            <td>
                                                <input type="time" class="form-control salida" id="salida_{{ strtolower($dia) }}" name="salida_{{ strtolower($dia) }}" value="{{ old('salida_'.strtolower($dia), $salidas[$index]) }}" disabled>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
    ...
    <script>
        ...
        function habilitarEdicion() {
            ...
            // Selecciona todos los inputs de entrada y salida y los habilita
